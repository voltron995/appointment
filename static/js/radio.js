$( document ).ready(function() {
    ...
    $('#id_started_at').datetimepicker({"pickTime": true, "language": "en", "format": "m/d/Y H:m:s", step: 15});
    $('#id_finished_at').datetimepicker({"pickTime": true, "language": "en", "format": "m/d/Y H:m:s", step: 15});
});
